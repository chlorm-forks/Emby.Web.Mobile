...
html+="</div>";html+="</a>";html+="</div>";html+='<div class="cardFooter visualCardBox-cardFooter">';html+="<div class='cardText'>";html+=plugin.name;html+="</div>";if(!plugin.isExternal){html+="<div class='cardText' style='display:flex;align-items:center;'>";if(plugin.avgRating){html+='<i class="md-icon" style="color:#cc3333;margin-right:.25em;">star</i>';html+=plugin.avgRating.toFixed(1);}

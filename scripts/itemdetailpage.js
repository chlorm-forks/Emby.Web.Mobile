(function($,document,window){var currentItem;function getPromise(){var id=getParameterByName('id');if(id){return ApiClient.getItem(Dashboard.getCurrentUserId(),id);}
...
function onItemDeleted(e,itemId){if(currentItem&&currentItem.Id==itemId){if(currentItem.Type=='Recording'){LibraryBrowser.showTab('livetv.html',3);}else{Dashboard.navigate('index.html');}}}
...
window.ItemDetailPage=new itemDetailPage();})(jQuery,document,window);
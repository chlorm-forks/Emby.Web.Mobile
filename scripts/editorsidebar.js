...
function scrollToNode(id){var elem=$('#'+id)[0];if(elem){elem.scrollIntoView();}}
...
function loadNodeCallback(node){if(selectedNodeId&&node.children&&node.children.indexOf(selectedNodeId)!=-1){setTimeout(function(){scrollToNode(selectedNodeId);},500);}}

define(['dialogHelper','jQuery'],function(dialogHelper,$){var currentRecognition;var lang='en-US';var commandgroups;function getCommandGroups(){if(commandgroups){return Promise.resolve(commandgroups);}
